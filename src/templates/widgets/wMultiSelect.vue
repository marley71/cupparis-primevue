        ...
        <template v-else >
          ...
          <div class="inline-flex align-items-center border-round"
            ...
            <div class="p-multiselect-label-container" data-pc-section="labelcontainer">
              <div class="p-multiselect-label" data-p="has-chip" data-pc-section="label">
                <span class="p-multiselect-chip-item" data-pc-section="chipitem">
                <div class="p-chip p-component p-multiselect-chip" data-pc-section="token">
                  <div class="p-chip-label" data-pc-section="label">{{ getMultiSelectLabel(option) }}</div>
                  <svg @click="removeMultiSelect(option)" width="14" height="14" viewBox="0 0 14 14" fill="none"
                       xmlns="http://www.w3.org/2000/svg" class="p-icon p-chip-remove-icon"
                       aria-hidden="true"
